        ...
        <PopoverGroup class="hidden lg:flex lg:gap-x-12">
          <Popover class="relative flex">
            ...
            <transition enter-active-class="transition ease-out duration-200" enter-from-class="opacity-0 translate-y-1"
              ...
              <PopoverPanel
                  class="absolute -left-8 top-full z-10 mt-3 w-screen max-w-md overflow-hidden rounded-3xl bg-cta-dark shadow-lg ring-1 ring-gray-900/5">
                <div class="p-2">
                  <div v-for="item in menu" :key="item.blogid"
                       class="group relative flex items-center gap-x-6 rounded-lg text-sm leading-6 hover:bg-gray-50">
                    <div class="flex-auto">
                      <a href="/" class="block font-semibold text-white p-3"
